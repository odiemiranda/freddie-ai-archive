...
**How to Apply**: Before performing a frequency-based analysis via `/sound`, validate the Style block against this six-factor checklist. Address structural failures first.
