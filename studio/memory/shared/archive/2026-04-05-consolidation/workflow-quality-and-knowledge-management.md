...
**Why:** Ensures higher quality outputs and prevents common generation pitfalls, including those specific to genre interpretation and agent design. The multi-stage approach provides comprehensive critique.
