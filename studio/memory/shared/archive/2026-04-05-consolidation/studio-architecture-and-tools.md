---
name: Studio Architecture and Tools
description: Core infrastructure, file organization, indexing, and tool execution constraints for the music studio, including practical insights for Music Cards.
type: knowledge
agent: shared
tags: [architecture, infrastructure, file-paths, indexing, tools, obsidian, mcp, claude-code, penny, music-cards, tasks, fusion, shamisen, celtic, harp, weirdness, style-influence]
---

# Studio Architecture and Tools
...
### Music Card Application Insights
- Cards effectively anchor warmth, tempo, and texture, with typed brackets handling fusion twists.
- Specific instrument pairings, like shamisen and celtic harp, work well when constrained to mid-low registers.
- Specific BPM and key combinations (e.g., F Major at 78 BPM) can define a desired mood (e.g., warm pastoral morning).
...
- **Output:** Generates `vault/studio/tracks-index.20260402-200615-a-multi-stage-critique-workflow-utilizin-2.mdjson` and `vault/studio/lyrics-index.json`.
