...
type: knowledge
agent: mccall
tags: [agent-capabilities, skill-development, workflow-management, structured-analysis, task-management, workflow-design, execution-planning, tech-review, data-extraction, self-improvement, dev-workflow, process-optimization, efficiency, meta-learning, tool-development, integration, cross-agent]
---
