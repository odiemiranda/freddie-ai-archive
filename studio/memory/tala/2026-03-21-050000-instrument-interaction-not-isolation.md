...
**How to apply:** In lyrics blocks, use dynamic interaction verbs (trades, weaves, responds, answers) not static isolation verbs (holds, sustains, sits under). At least one line per section should describe how instruments relate. Also embed structure in Style blocks ([Intro]...[Build]...[Hook]) to give Suno a journey, not a snapshot of descriptors.
