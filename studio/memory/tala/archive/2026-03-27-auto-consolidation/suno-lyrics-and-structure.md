---
name: suno-lyrics-and-structure
description: Unified typed bracket framework for ALL Suno Lyrics, providing section-level control over instrumentation, energy, mood, texture, and vocal style.
type: knowledge
agent: tala
tags: [suno, lyrics, typed-brackets, instrument, energy, mood, texture, vocal-style, unified, structure, tags]
---
...
| Elongated Notes | Syllable stretch | `~word~` | Suno stretches the syllable. |
| Smooth Cutoff | Clean stop | `word-` | Creates a smooth cut off/stop. |
...
---
*Consolidated from: `suno-lyrics-and-structure.md` (original), `schwepps-pattern-test-results.md`, `typed-brackets-vocal-strategy.md`, `unified-typed-brackets.md`*
