...
type: knowledge
agent: tala
tags: [suno, prompt-design, complexity, genre, quality, reroll, iteration, signal-clarity, instrumentation, arrangement, audio-quality, critic, prompt-refinement]
---
...
### Why
Cultural labels trigger unrequested genre-associated instruments (e.g., violin, fiddle for "Celtic") even with explicit exclusions. Specific genre archetypes can also introduce subtle audio quality issues.
...
---
*Consolidated from: `suno-prompt-principles.md`, `suno-lyrics-and-structure.md`, `20260329-002043-specific-genre-archetypes-can-introduce--1.md`*
