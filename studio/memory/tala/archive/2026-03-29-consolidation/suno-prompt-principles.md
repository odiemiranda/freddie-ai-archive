...
description: Core principles for clean, high-signal prompt design, complexity limits, genre precision, and quality expectations for Suno, including specific considerations for instrument arrangement.
type: knowledge
agent: tala
tags: [suno, prompt-design, complexity, genre, quality, reroll, iteration, signal-clarity, instrumentation, arrangement]
---
...
-   **Max 3 instruments:** Use specific instrument names (e.g., "cello" instead of "low strings"). Overlapping registers cause frequency fighting. For example, organs can cause frequency stacking issues; consider pulling them from verses and reintroducing them in choruses or bridges for impact and clarity.
...
---
*Consolidated from: `suno-prompt-principles.md`, `20260328-221905-organs-can-cause-frequency-stacking-issu-3.md`*
