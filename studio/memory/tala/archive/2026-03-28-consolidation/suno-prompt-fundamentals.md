---
name: suno-prompt-fundamentals
description: Core principles for clean, high-signal prompt design, complexity limits, genre precision, quality expectations, and workflow feedback for Suno.
type: knowledge
agent: tala
tags: [suno, prompt-design, complexity, genre, quality, reroll, multi-critic, llm-feedback, iteration, signal-clarity]
---

# Suno Prompt Engineering Fundamentals
...
---
*Consolidated from: `suno-prompt-principles.md`, `20260327-040817-a-validated-genre-archetype-even-if-it-t-4.md`, `20260327-040817-abstract-or-potentially-ambiguous-vibe-t-3.md`, `20260327-040817-when-describing-instruments-especially-s-2.md`, `iteration-workflow-learnings.md`, `20260326-205216-relying-on-a-single-critic-for-comprehen-2.md`, `20260326-205216-gemini-s-feedback-regarding-instrumental-1.md`, `20260326-213239-when-using-llms-like-gemini-for-prompt-r-5.md`*
