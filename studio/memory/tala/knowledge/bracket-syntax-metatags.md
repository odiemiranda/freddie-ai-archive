...
**Structure tags:** `[Intro]`, `[Verse]`, `[Chorus]`, `[Hook]`, `[Bridge]`, `[Break]`, `[Breakdown]`, `[Build]`, `[Outro]`, `[Fade Out]`, `[Sustained]`, `[End]`. Place at start of each section — signals Suno that a pattern/meter shift is coming.
