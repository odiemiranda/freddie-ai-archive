...
- Trust that raw context for reflections is now automatically captured, providing comprehensive input for memory creation without manual intervention, specifically through PostToolUse, PreCompact, and Stop hooks with exchange-level chunking.
