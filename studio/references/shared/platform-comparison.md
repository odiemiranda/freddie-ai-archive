...
| **Second opinion on any prompt** | `/gemini critique` | Echo calls Gemini CLI, cross-references against both platforms' reference data |
| **Unfamiliar genre research** | `/gemini research` | Gemini researches conventions, Echo validates against our references |
| **Mix/frequency analysis** | `/gemini engineer` | Gemini maps frequencies, Echo cross-checks our instrument register |
